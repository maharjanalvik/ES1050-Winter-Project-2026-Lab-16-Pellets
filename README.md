...
A modular, open-source mechanical system designed to convert shredded plastic waste into uniform, high-quality pellets suitable for 3D printing and injection molding applications.
...
2. Follow the assembly instructions in `/CAD` and `/Electronics`  
3. Upload firmware from `/Code` to the microcontroller  
4. Calibrate speed and temperature based on your material  

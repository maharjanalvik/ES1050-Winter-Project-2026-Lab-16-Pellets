...
// Clamped to [STEPPER_MIN_SPEED_VAL, 127]. The MKS SERVO42C won't
// reliably turn at very low speed values, so we enforce a minimum.

#define STEPPER_MIN_SPEED_VAL   5  // MKS won't reliably move below this
